  ...
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-24 mb-12">
      <motion.div 
        ...
        className="cta-card glass rounded-3xl p-12 text-center relative overflow-hidden"
      >
        ...
        <div className="relative z-10">
          ...
          <Link href="/register">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="btn-brand px-8 py-4 text-lg rounded-2xl font-bold shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 transition-shadow"
            >
